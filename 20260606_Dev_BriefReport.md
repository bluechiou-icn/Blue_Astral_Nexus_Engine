...
**驗證：** Blue 1987/5/19 → 2026 虛齡 40 ✓；1987/1/15（立春前） → 干支年 1986 → 虛齡 41 ✓
...
**驗證：** Blue 田宅宮 (乙巳) 武曲完整顯示、命宮(寅) / 父母宮(卯) 顯示 `空宮 / 借遷移宮` / `空宮 / 借疾厄宮`、福德宮顯示直書「小限」紅框 ✓
...
**例：** 點 Blue 流命 (午) → 連到 子(夫妻/流遷)、戌(財帛/流財)、寅(命宮/流官) ✓
