...
const I18N = {
  zh: {
    ...
    login_required_cast: '請先登入才能起盤。',
    unknown_time_label: '不確定時辰（以午時起盤，僅供參考）',
    uncertain_time_notice: '由於您無法確認生辰時間，此命盤僅為參考。如需進行定盤服務（確認生日生辰）請聯繫我們。',
    err_failed: '命盤計算失敗：',
    meta_wuxing: '五行局', meta_yinyang: '陰陽',
    meta_ming: '命宮', meta_zhuxing: '主星', meta_body: '身宮', meta_origin: '來因宮',
    meta_empty_borrow: '空宮借對宮 ',
  ...
  en: {
    ...
    login_required_cast: 'Please sign in to generate a chart.',
    unknown_time_label: 'Birth time unknown (cast at noon; reference only)',
    uncertain_time_notice: 'Because the birth time could not be confirmed, this chart is for reference only. For a time-rectification service, please contact us.',
    err_failed: 'Chart calculation failed: ',
    meta_wuxing: 'Five Elements', meta_yinyang: 'Yin/Yang',
    meta_ming: 'Life Palace', meta_zhuxing: 'Major Stars', meta_body: 'Soul Palace', meta_origin: 'Origin Palace',
    meta_empty_borrow: 'Empty · borrows ',
  ...
  ko: {
    ...
    login_required_cast: '명반을 생성하려면 먼저 로그인하세요.',
    unknown_time_label: '출생 시간 미상 (오시로 작성, 참고용)',
    uncertain_time_notice: '출생 시간을 확인할 수 없어 이 명반은 참고용입니다. 시간 보정 서비스가 필요하면 문의해 주세요.',
    err_failed: '명반 계산 실패: ',
    meta_wuxing: '오행국', meta_yinyang: '음양',
    meta_ming: '명궁', meta_zhuxing: '주성', meta_body: '신궁', meta_origin: '래인궁',
    meta_empty_borrow: '공궁 차대궁 ',
