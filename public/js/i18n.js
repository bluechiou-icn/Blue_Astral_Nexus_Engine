...
const I18N = {
  zh: {
    ...
    lib_locked_count: '🔒 已儲存 {n} 筆命例（內容已隱藏）。請登入 Google 帳號查看與管理。',
    lib_locked_empty: '🔒 請登入 Google 帳號開始使用命例庫；未登入時不會顯示任何資料。',
    ...
    syn_matrix_hint:     '箭頭從 A／B 的生年（或當前大限）四化星，連到落入對方命盤的對應宮位；hover 箭頭可看細節。',
  ...
  en: {
    ...
    lib_locked_count: '🔒 {n} chart(s) saved (details hidden). Sign in with Google to view and manage them.',
    lib_locked_empty: '🔒 Sign in with Google to start using the chart library. Nothing is shown while signed out.',
    ...
    syn_matrix_hint:     'Arrows trace A/B birth-year (or current major-limit) mutations into the partner’s palaces. Hover an arrow for details.',
  ...
  ko: {
    ...
    lib_locked_count: '🔒 {n}개 명례 저장됨 (내용 숨김). Google 로그인하여 보기 및 관리하세요.',
    lib_locked_empty: '🔒 Google 로그인하여 명례 보관함을 시작하세요. 로그아웃 상태에서는 표시되지 않습니다.',
