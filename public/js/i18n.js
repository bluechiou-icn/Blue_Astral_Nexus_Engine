...
const I18N = {
  zh: {
    ...
    partner_date_label: '配偶生日', partner_time_label: '配偶時間',
    partner_gender_label: '配偶性別',
    partner_name_label: '配偶姓名（選填，default 異性戀夫婦）',
  ...
  en: {
    ...
    partner_name_label: 'Partner Name (optional, default heterosexual)',
  ...
  ko: {
    ...
    partner_name_label: '배우자 이름 (선택, 기본: 이성)',
